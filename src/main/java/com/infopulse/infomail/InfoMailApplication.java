...
@OpenAPIDefinition(info = @Info(title = "Infomail API", version = "1.0", description = "This is an email service, that allows to schedule sending of emails and share email templates"))
